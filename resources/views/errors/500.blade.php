 ...
 <div class="row">
    <div class="col-md-12">
      <div class="main-icon text-warning"><span class="uxicon uxicon-alert"></span></div>
        <h1>Internal Server Error (500 error)</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6 col-md-push-3">
      <p class="lead">We have bad days too, but if this has happened more than once please contact the <a href="mailto://support@simcycreative.com">site admin</a>.</p>
    </div>
  </div>
</div>
